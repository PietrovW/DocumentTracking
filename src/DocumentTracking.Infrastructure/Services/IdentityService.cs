...
namespace DocumentTracking.Infrastructure.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public IdentityService(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager,IEmailService emailSender , IJWTTokenHandler jwtTokenHandler)
        {

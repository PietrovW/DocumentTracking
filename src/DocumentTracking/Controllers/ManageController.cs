...
using DocumentTracking.ApplicationCore.Interfaces;
using DocumentTracking.Infrastructure.Identity;
...
{
    public class ManageController : SecurityControllersBase
    {
        private readonly UserManager<ApplicationUser> userManager;
        private readonly SignInManager<ApplicationUser> signInManager;
        private readonly IEmailSender _emailSender;
        private readonly IAppLogger<ManageController> logger;
